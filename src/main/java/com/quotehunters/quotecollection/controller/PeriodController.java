...
public class PeriodController {
    ...
    private final PeriodService periodService = new PeriodService();   // 주방장 준비
    ...
    public String registPeriod(String periodName) {
        ...
        return result > 0 ? "시대가 등록되었습니다." : "시대 등록에 실패했습니다.";
    }
    ...
    public String modifyPeriod(int periodId, String periodName) {
        ...
        return result > 0 ? "시대가 수정되었습니다." : "시대 수정에 실패했습니다.";
    }
    ...
    public String removePeriod(int periodId) {
        ...
        // 삭제 성공 시 명세 S8-1의 완료 메시지 반환
        return result > 0 ? "시대가 삭제되었습니다." : "시대 삭제에 실패했습니다.";
    }
}
